...
For detailed steps with screenshots including how to register your site on Google Custom search please visit http://wordpressindex.com/replace-wordpress-search-with-google-custom-search-cse/
...
Visit: http://wordpressindex.com/replace-wordpress-search-with-google-custom-search-cse/


== Changelog ==
1.1: January 31, 2016

Fix - Search form ID giving error
Fix - form security (sanitise fields)
